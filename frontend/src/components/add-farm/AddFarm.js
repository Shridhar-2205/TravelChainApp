        ...
        <div className="container">
          <div className="row">
            <div className="col-md-5 m-auto">
              ...
              <h2 className="display-8 text-center">Add Farm</h2>
              <p className="lead text-center">
                Add the Farm you want to make available for Traveller
              </p>
              ...
              <form onSubmit={this.onSubmit}>
                ...
                />
                <TextFieldGroup
                  placeholder="Farm Location or City Name"
                  name="houseLocation"
                ...
                <TextFieldGroup
                  type="number"
                  min="1"
                  placeholder="Farm Guest Capacity"
                  name="guestCapacity"
                  value={this.state.guestCapacity}
                  onChange={this.onChange}
                  error={errors.guestCapacity}
                />
                <h6>Farm Available From Date</h6>
                <TextFieldGroup
                ...
                />
                <h6>Farm Available Till Date</h6>
                <TextFieldGroup
                ...
                <TextFieldGroup
                  ...
                  info="Farm Price must be per Night in USD"
                />
                ...
                <TextFieldGroup
                  ...
                  info="Farm Area must in Square feet"
                />

                <TextFieldGroup
                  placeholder="Farm Image Url"
                  name="houseImage"
                  value={this.state.houseImage}
                  onChange={this.onChange}
                  error={errors.houseImage}
                  info="Farm Image field should be an image URL"
                />
...
export default connect(mapStateToProps, { addHomes })(withRouter(AddFarm));
