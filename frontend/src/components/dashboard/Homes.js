    ...
    if (allhomes === null || loading) {
      homeItems = (
        <h4 className="text-center">
          No services have been added by the any of the service providers so far
        </h4>
      );
    } else {
      if (allhomes.length > 0) {
        ...
        for (i = 0; i < allhomes.length; i++) {
          if (allhomes[i].houseName.substring(0, 4) == "Home") {
        ...
        homeItems = (
          <h4 className="text-center">
            No services have been added by the any of the service providers so
            far
          </h4>
        );
      }
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <p className="lead text-center">
                <i>
                  Find the best homes around the Country for affordable prices
                </i>
              </p>
              {homeItems}
              <br />
