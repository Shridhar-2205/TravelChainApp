      ...
      <div className="card card-body bg-light mb-3">
            ...
            <div className="row">
              <div className="col-6 text-left">
                ...
                <h5>
                  $
                  {parseFloat(
                    Math.round(Number(homes.housePrice * 0.1) * 100) / 100
                  ).toFixed(2)}
                  ....{" "}
                </h5>
                <h5>$50....</h5>
                <h3>
                  ...
                  {parseFloat(
                    Math.round(
                      (homes.housePrice + Number(homes.housePrice) * 0.1 + 50) *
                        100
                    ) / 100
                  ).toFixed(2)}
                  ....
        ...
        <div className="row">
          <div className="col-lg-8 col-md-8 text-center">
            <p>
              <i>Home owned by {homes.houseOwnerName}</i>
            </p>
          </div>
        </div>
        <br />
        <div className="row">
          ...
          <div className="col-lg-3 col-md-3 text-center">
            <h5>
              <i className="fas fa-bath fa-lg" /> 2 bath
            </h5>
          </div>
          <div className="col-lg-3 col-md-3 text-center">
            <h5>
              <i className="fas fa-home" /> {homes.houseArea}sqft
            </h5>
          </div>
        </div>
        <br />
...
export default connect(mapStateToProps)(IndHelicopterItem);
