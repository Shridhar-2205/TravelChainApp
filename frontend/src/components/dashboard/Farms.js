    ...
    if (allhomes === null || loading) {
      homeItems = (
        <h4 className="text-center">
          No Farms have been added by the any of the home owners so far
        </h4>
      );
    } else {
      if (allhomes.length > 0) {
        ...
        for (i = 0; i < allhomes.length; i++) {
          if (allhomes[i].houseName.substring(0, 4) == "Farm") {
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="row">
                ...
                <div className="col-8">
                  <h2 className="display-8 text-center">Farms Available</h2>
                </div>
              ...
              <p className="lead text-center">
                <i>
                  Find the best Farms around the Country for affordable prices
                </i>
              </p>
              {homeItems}
              <br />
