...
const mlab_db ="mongodb+srv://travelappdb:travelappdb@cluster0-m1klw.mongodb.net/tourapp?retryWrites=true&w=majority";
mongoose
  .connect(mlab_db)
...
app.get(
  ...
  (req, res) => {
      ...
      Home.find(
        {}, 
        {houseOwnerName:1, houseName: 1, houseLocation: 1, housePrice:1}
        )
        .then(response => {
          res.json(response)
        })
